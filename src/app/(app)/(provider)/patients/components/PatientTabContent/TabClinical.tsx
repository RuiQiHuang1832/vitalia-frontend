    ...
    <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
      ...
      <Card className="overflow-hidden py-0 gap-0">
        ...
        <div className="divide-y divide-gray-100">
          {allergies.length === 0 ? (
            <CardContent className="py-6 text-sm text-muted-foreground">No allergies recorded.</CardContent>
          ) : (
      ...
      <section className="bg-white rounded-xl border border-gray-200 shadow-sm col-span-2">
        ...
        <div className="p-4 border-b border-gray-100 flex items-center gap-2">
          ...
          <h3 className="font-semibold text-gray-800 text-[16px]">Medication List</h3>
        </div>
        <Table>
          <TableHeader>
            <TableRow>
